          ...
          <div className='flex relative dark:bg-main-dark-bg'>
              <div className='fixed right-4 bottom-4 z-[1000px]'>
                ...
                <div>
                  ...
                  style={{background: currentColor}} className='text-3xl text-white hover:bg-light-gray rounded-full hover:drop-shadow-xl p-3'>
                    <FiSettings/>
                  </button>
                </div>
                    </Tooltip>
              ...
              <div className={`dark:bg-main-dark-bg bg-min-bg min-h-screen w-full ${activeMenu ? "md:ml-72" : " flex-2"}`}>
